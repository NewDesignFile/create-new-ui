...
import { ProjectConfig, FRAMEWORKS, BUNDLERS } from '../config.js';
 ...
 */
function createDependencyImports(config: ProjectConfig): string {
  const imports = [];
  if (config.dependencies.includes('reset')) imports.push("import '@new-ui/reset';");
  if (config.dependencies.includes('colors')) imports.push("import '@new-ui/colors';");
  if (config.dependencies.includes('typography')) imports.push("import '@new-ui/typography';");
  if (config.dependencies.includes('spacings')) imports.push("import '@new-ui/spacings';");
  if (config.dependencies.includes('effects')) imports.push("import '@new-ui/effects';");
 ...
 * @param projectDir - Project directory path
 */
async function generateReactFiles(config: ProjectConfig, projectDir: string): Promise<void> {
  // Create main.tsx
 ...
 * @param projectDir - Project directory path
 */
async function generateVueFiles(config: ProjectConfig, projectDir: string): Promise<void> {
  // Create main.ts
 ...
 * @param projectDir - Project directory path
 */
async function generateSvelteFiles(config: ProjectConfig, projectDir: string): Promise<void> {
  // Create main.ts
 ...
 * @param projectDir - Project directory path
 */
async function generateVanillaFiles(config: ProjectConfig, projectDir: string): Promise<void> {
  // Create main.ts
