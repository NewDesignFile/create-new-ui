 ...
 */
export function handleCancel(input: unknown): boolean {
  if (isCancel(input)) {
...
export async function collectProjectConfig(): Promise<ProjectConfig> {
  ...
  if (handleCancel(projectName)) process.exit(0);
  ...
  if (handleCancel(newUiDependencies)) process.exit(0);
  ...
  if (config.dependencies.length === 0) {
    ...
    if (handleCancel(continueDespiteNoDeps)) process.exit(0);
  ...
  if (handleCancel(includeFramework)) process.exit(0);
  ...
  if (includeFramework) {
    ...
    if (handleCancel(framework)) process.exit(0);
  ...
  if (handleCancel(includeBundler)) process.exit(0);
  ...
  if (includeBundler) {
    ...
    if (handleCancel(bundler)) process.exit(0);
  ...
  if (handleCancel(confirmed)) process.exit(0);
