 ...
 */
export function displaySuccessMessage(config: ProjectConfig, projectDir: string): void {
  outro(
    colors.green(`
 ...
 * @param projectDir - Project directory path
 */
export async function completeSetup(config: ProjectConfig, projectDir: string): Promise<void> {
